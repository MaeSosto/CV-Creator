...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 05, 2019 at 12:36 PM
...
--
-- Table structure for table `digitali`
--
...
--
-- Dumping data for table `digitali`
--
...
('Martina', '53e5db093f8e47c7564bbb869385e352', '8ab92981655adc3b28c2d4ae111fa393', 'martina.sosto@gmail.com', 'Martina', 'Sosto', '1998-01-28', 'Bologna', 'femmina', 'Italiana', '3312291798', '0532825512', 'b', '../uploads/IMG_20190807_195752.jpg', 'Continuare negli studi per accrescere le mie conoscenze informatiche e in seguito, cosÃ¬, intraprendere un percorso di carriera coerente con le mie esperienze precedenti che mi possa portare a migliorare a crescere personalmente e professionalmente.', 'Partecipato attivamente al gruppo scoutistico CNGEI (http://www.cngei.it) fin dall&#39etÃ  di 9 anni, amante dell&#39aria aperta e dello stare in compagnia.\r\nLa mia passione per i videogame e le serie Tv mi ha portata sempre piÃ¹ ad avvicinarmi al mondo dell&#39informatica, dove ho scoperto alcune delle mie piÃ¹ grandi passioni tra le quali programmare.', 'Italiano'),
...
--
-- AUTO_INCREMENT for table `digitali`
--
ALTER TABLE `digitali`
  MODIFY `iddigitali` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;

--
-- AUTO_INCREMENT for table `formazione`
--
ALTER TABLE `formazione`
  MODIFY `idformazione` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=34;

--
-- AUTO_INCREMENT for table `lavoro`
--
ALTER TABLE `lavoro`
  MODIFY `idlavoro` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=60;

--
-- AUTO_INCREMENT for table `lingua`
--
ALTER TABLE `lingua`
  MODIFY `idlingua` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=22;
COMMIT;
